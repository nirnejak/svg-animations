...
const Footer: React.FC = () => {
  return (
    <motion.footer
      ...
      transition={{ delay: 3 }}
      className="fixed bottom-5 left-1/2 w-[calc(100vw-30px)] -translate-x-1/2 rounded-md bg-white px-3 py-2 text-center text-sm text-zinc-700 shadow-lg md:w-max"
    >
